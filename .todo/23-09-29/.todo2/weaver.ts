...
import type { Call, Manifest, TemplateArgs, Value } from "./lit.ts";

/** HELPERS **/

function getManifest(mod: unknown): Manifest | null {
...
export function create(manifest: Manifest, sources?: {
  program: Program;
  text: string;
}) {
}
