import type { WalkEntry, WalkOptions } from "$std/fs/walk.ts";
import { walk as walkImpl } from "$std/fs/walk.ts";
...
const template = (routes: WalkOptions) => `
